...
<div style="margin: 3rem 0; background: transparent; border: 1px solid var(--border); overflow: hidden;">
  <iframe src="/static/caching-prefix-viz.html" style="width: 100%; height: 400px; border: none;" scrolling="no"></iframe>
</div>
...
<div style="margin: 3rem 0; background: transparent; border: 1px solid var(--border); overflow: hidden;">
  <iframe src="/static/caching-calculator.html" style="width: 100%; height: 400px; border: none;" scrolling="no"></iframe>
</div>
