...
Against the day-90 band of **306–1,176 human clicks/month**: the trailing 28 days produced **0**. That is below the floor, and not marginally: the floor assumes the campaign produces human clicks at all.
...
| 2 | Developer experience & DevRel | 8 | 0 | 0 | 0 |
| 3 | AI agents, memory, RAG, inference | 57 | 1 | 0 | 1 |
| 4 | AI Overviews & AI-search citation | 8 | 0 | 0 | 0 |
| 5 | Reddit marketing | 0 | 0 | 0 | 0 |
| 6 | Forums & community building | 0 | 0 | 0 | 0 |
| 7 | Technical & community events | 0 | 0 | 0 | 0 |
| — | Pages in no cluster | — | 1 | 0 | 1 |

**Shipped but earning nothing named:** cluster 2 (8 live surfaces), cluster 4 (8 live surfaces). Something has been tried here and has not landed yet.

**Nothing live yet:** cluster 5, cluster 6, cluster 7. A zero here means nothing has been published, not that it failed.

### 5. Does the trajectory reach 10,000/month by 2026-11-15?

No. Human non-brand clicks over the trailing 28 days are zero, so there is no rate to extrapolate and no multiple to quote: 10,000 from zero is not a multiple, it is a standing start with 90 days left. Reaching even the band's floor of 306/month requires a change in kind rather than degree, and reaching 10,000 is 8.5x beyond the band's own ceiling of 1176, so the target was never reachable by publishing inside 90 days.
...
No. Human non-brand clicks over the trailing 28 days are zero, so there is no rate to extrapolate and no multiple to quote: 10,000 from zero is not a multiple, it is a standing start with 90 days left. Reaching even the band's floor of 306/month requires a change in kind rather than degree, and reaching 10,000 is 8.5x beyond the band's own ceiling of 1,176, so the target was never reachable by publishing inside 90 days.
