...
Maintained by `tools/gsc_report.py`, one authoritative section per date. Movement, decay, and striking distance,
...
Current window 2026-07-19 to 2026-08-15 (28d), against 2026-06-21 to 2026-07-18. Windows end 3 days back because Search Console lags.

**Sitewide** 10 clicks / 1566 impressions, avg pos 15.7 (prior 23 / 2729, pos 13.8).

Query dimension sees 325 impressions across 76 named queries — a **floor**, not a total: Search Console withholds low-volume queries.
...
| # | Cluster | Pages | Clicks | Impressions | Avg pos |
|---:|---|---:|---:|---:|---:|
| 1 | Technical documentation & docs ops | 14 | 0 | 118 | 46.1 |
| 2 | Developer experience & DevRel | 4 | 1 | 31 | 14.1 |
| 3 | AI agents, memory, RAG, inference | 44 | 0 | 1168 | 11.6 |
| 4 | AI Overviews & AI-search citation | 1 | 0 | 2 | 18.0 |
| 5 | Distribution: Reddit, forums, communities, events | 0 | 0 | 0 | — |
| — | homepage | 1 | 8 | 131 | 8.4 |
| — | /work/ (case studies) | 5 | 0 | 82 | 16.1 |
| — | /about/ (bio) | 1 | 0 | 64 | 8.2 |
| — | /glossary/ (25 terms, republished 2026-08-17) | 13 | 0 | 63 | 36.3 |
| — | /contact/ | 1 | 0 | 37 | 7.2 |
| — | /portfolio/ | 1 | 0 | 34 | 4.5 |
| — | /projects/ | 1 | 0 | 27 | 6.3 |
| — | /static/ (assets, should not rank) | 15 | 0 | 25 | 35.1 |
| — | /blog/ | 3 | 0 | 18 | 5.7 |
| — | /topics/ | 1 | 0 | 18 | 7.3 |
| — | /terms/ | 1 | 0 | 17 | 4.6 |
| — | /articles/ | 1 | 1 | 11 | 4.4 |
...
**Post-path split:** 110 impressions on the canonical `/articles/` path against 1236 on the legacy `/blog/` path (92% legacy), plus 509 elsewhere. Both prefixes map to the same cluster here, since the slug identifies the post; a high legacy share means the migration is still unresolved.

### What moved


**Pages** — 28 moved more than 3 places.

| Page | Pos | Prior | Δpos | Clicks Δ | Impr Δ |
|---|---:|---:|---:|---:|---:|
| https://ninadpathak.com/ai-agent-architecture/ | 12.5 | 32.9 | **+20.4** up | +0 | -7 |
| https://ninadpathak.com/blog/structured-outputs-llms-json-mode-functio | 45 | 24.9 | **-20.1** down | +0 | -16 |
| https://ninadpathak.com/blog/memory-hierarchy-in-ai-systems/ | 18.2 | 34 | **+15.8** up | +0 | -5 |
| https://ninadpathak.com/portfolio/ | 4.5 | 20.1 | **+15.6** up | +0 | -42 |
| https://ninadpathak.com/blog/kv-cache-eviction-accuracy/ | 7.8 | 22.1 | **+14.3** up | +0 | -130 |
| https://ninadpathak.com/blog/mixture-of-experts-explained/ | 22 | 8.8 | **-13.2** down | +0 | -15 |
| https://ninadpathak.com/blog/llm-inference-optimization/ | 48 | 58.2 | **+10.2** up | +0 | -75 |
| https://ninadpathak.com/blog/engineering-velocity-documentation/ | 5 | 15 | **+10.0** up | +0 | -17 |
| https://ninadpathak.com/work/kiwisizing/ | 30.3 | 20.9 | **-9.4** down | -1 | +7 |
| https://ninadpathak.com/blog/short-term-memory-for-ai-agents/ | 17.7 | 27 | **+9.3** up | +0 | -14 |
| https://ninadpathak.com/blog/technical-writing-for-ai-products-the-new | 18.9 | 9.8 | **-9.0** down | +1 | +2 |
| https://ninadpathak.com/glossary/agentic-router/ | 17.6 | 8.8 | **-8.9** down | +0 | -3 |
| https://ninadpathak.com/glossary/late-chunking/ | 38.4 | 29.6 | **-8.8** down | +0 | -3 |
| https://ninadpathak.com/blog/state-of-ai-agent-memory-2026/ | 10.3 | 18.9 | **+8.6** up | +0 | -23 |
| https://ninadpathak.com/blog/how-memory-works-in-deerflow/ | 10 | 17.4 | **+7.4** up | +0 | -13 |
| https://ninadpathak.com/blog/embedding-models-compared/ | 31.6 | 24.4 | **-7.3** down | +0 | +0 |
| https://ninadpathak.com/work/delightchat/ | 26.1 | 19 | **-7.1** down | +0 | +1 |
| https://ninadpathak.com/blog/agentic-workflow-playbook/ | 14.4 | 7.5 | **-7.0** down | +0 | -26 |
| https://ninadpathak.com/blog/shared-vs-isolated-memory-multi-agent/ | 4.8 | 11.6 | **+6.8** up | +0 | -19 |
| https://ninadpathak.com/blog/how-stripes-technical-blog-became-a-compe | 13.6 | 6.9 | **-6.7** down | +0 | -53 |
...
51 page(s) lost impressions or position, prior window at least 5 impressions. A decaying page wants a refresh, not a new article.

| Page | Impr | Prior | Δ | Pos | Δpos |
|---|---:|---:|---:|---:|---:|
| https://ninadpathak.com/blog/how-anthropics-contextual-retrieval-chang | 740 | 1301 | -561 | 8.3 | -0.1 |
| https://ninadpathak.com/blog/kv-cache-eviction-accuracy/ | 5 | 135 | -130 | 7.8 | +14.3 |
| https://ninadpathak.com/about/ | 64 | 146 | -82 | 8.2 | -2.4 |
| https://ninadpathak.com/blog/llm-inference-optimization/ | 2 | 77 | -75 | 48 | +10.2 |
| https://ninadpathak.com/blog/local-wasm-vector-benchmarks/ | 13 | 69 | -56 | 7.5 | +0.8 |
| https://ninadpathak.com/blog/how-stripes-technical-blog-became-a-compe | 17 | 70 | -53 | 13.6 | -6.7 |
| https://ninadpathak.com/portfolio/ | 34 | 76 | -42 | 4.5 | +15.6 |
| https://ninadpathak.com/blog/rag-evaluation-metrics-what-actually-matt | 0 | 40 | -40 | — | — |
| https://ninadpathak.com/blog/how-memory-works-in-claude-code/ | 0 | 27 | -27 | — | — |
| https://ninadpathak.com/blog/agentic-workflow-playbook/ | 9 | 35 | -26 | 14.4 | -7.0 |
| https://ninadpathak.com/blog/state-of-ai-agent-memory-2026/ | 24 | 47 | -23 | 10.3 | +8.6 |
| https://ninadpathak.com/blog/voice-ai-latency-gemini-benchmark/ | 23 | 45 | -22 | 9.2 | +0.5 |
| https://ninadpathak.com/blog/fine-tuning-vs-rag-for-agent-memory/ | 33 | 54 | -21 | 12.1 | -2.2 |
| https://ninadpathak.com/blog/shared-vs-isolated-memory-multi-agent/ | 5 | 24 | -19 | 4.8 | +6.8 |
| https://ninadpathak.com/blog/engineering-velocity-documentation/ | 4 | 21 | -17 | 5 | +10.0 |
| https://ninadpathak.com/blog/structured-outputs-llms-json-mode-functio | 1 | 17 | -16 | 45 | -20.1 |
| https://ninadpathak.com/blog/mixture-of-experts-explained/ | 2 | 17 | -15 | 22 | -13.2 |
| https://ninadpathak.com/blog/state-of-open-source-memory-2026/ | 0 | 15 | -15 | — | — |
| https://ninadpathak.com/blog/semantic-caching-rag-optimization/ | 10 | 25 | -15 | 20.1 | +3.1 |
| https://ninadpathak.com/blog/short-term-memory-for-ai-agents/ | 16 | 30 | -14 | 17.7 | +9.3 |

### What is close

47 queries sit in positions 4–30 carrying 255 impressions. Separated out: 28 machine fan-out variants (149 impressions), 5 brand (57), 1 pasted blob (1), 8 below the 3-impression floor (8).
...
| Query | Impr | Clicks | Pos | Stopword ratio |
|---|---:|---:|---:|---:|
| ai agent memory vs fine-tuning for domain-specific knowledge retention | 14 | 0 | 6.6 | 0.22 |
| how do you handle errors when ai agents make mistakes in production? | 11 | 0 | 10.6 | 0.5 |
| roman hresko | 8 | 0 | 22.4 | 0.0 |
| how do companies debug ai agents that fail in production? | 4 | 0 | 10.2 | 0.4 |
| technical tutorial | 3 | 0 | 10 | 0.0 |
