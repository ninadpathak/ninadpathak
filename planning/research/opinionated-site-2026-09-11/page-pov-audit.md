...
- Published articles: 87 (50 EVIDENCE_REQUIRED, 33 PROVISIONAL_REVIEW, 1 REWRITE_BATCH, 3 PHASE_A_EDITED)
- Automated provenance sweep: 114 candidates across 50 of 87 articles
...
- `PROVISIONAL_REVIEW`: inventory is complete and no automated provenance candidate was found. This is not semantic approval.
...
| Article | `developer-onboarding-docs-what-works-what-doesnt.md` | REWRITE_BATCH | Thesis candidate: “On day two, your new engineer is asking which Node version to use, whether Docker is required, and where the test credentials live.” No automated provenance candidate, but the recorded structure or voice problem still needs a human rewrite. |
...
| Article | `documentation-review-checklist-before-you-publish.md` | PROVISIONAL_REVIEW | Thesis candidate: “The pull request is ready for review, and the comments are all about headings, wording, and screenshot placement.” Automated sweep found no provenance candidate; human evidence and editorial review remain pending. |
| Article | `documentation-style-guide-template-for-developer-teams.md` | EVIDENCE_REQUIRED | Thesis candidate: “Documentation drifts when a feature changes and the name in the UI no longer matches the command in the guide.” Automated sweep found 1 provenance candidate; a human must classify each KEEP, REWRITE, or CUT. |
...
| Article | `how-to-organize-a-documentation-site.md` | PROVISIONAL_REVIEW | Thesis candidate: “Your documentation started with a limited set of pages tied to a limited set of features.” Automated sweep found no provenance candidate; human evidence and editorial review remain pending. |
